<div id="lamina">
    <div class="dibujo pscover-media relative bg-lime-50">
        <div id="dibulamina"><img class="lamina-preview-img" src="../../../config/img/laminas/laminas.jpg" width="100%"></div>
    </div>
    ...
    <div class="formtemp pscover-form flex flex-col">
        ...
        <div class="salto" style="height: 30px;"></div>
        <div id="divpc" class="lamina-color-grid" style="display: none;">
        ...
        <div class="botones pscover-actions flex items-center gap-3">
            <div class="divsiguiente"><button id="btnlaminaS" class="btnsiguiente">Siguiente <img
                        src="../../../config/img/flecha-s.png" align="absmiddle"></button></div>
            <div class="divanterior"><button id="btnlaminaA" class="btnanterior"><img
