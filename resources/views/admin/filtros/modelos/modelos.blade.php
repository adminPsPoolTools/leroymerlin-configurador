...
@section('title', 'Modelos Filtros')

@section('content_header')
    <h1>Modelos filtros</h1>
@stop

@section('content')
    <div class="w-1/3 float-left">
        <a class="text-primary tamaño-logos mb-1 mr-1" href="{{ route('admin.modelos.filtros.create') }}">Nuevo modelo <i
                            ...
                            <td class="w-1/12 align-middle">
                                <div class="align-middle text-center">
                                    <a class="text-primary tamaño-logos mb-1 mr-1"
                                        href="{{ route('admin.modelos.filtros.edit', $modelo->id) }}">
                                        <i class='fas fa-edit'></i>
                                    </a>
                                </div>
                                <div class="align-middle text-center">
                                    <form action="{{ route('admin.modelos.filtros.delete', $modelo->id) }}" method="GET"
