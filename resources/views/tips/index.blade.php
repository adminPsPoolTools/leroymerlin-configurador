...
<main class="home">
    ...
    <x-header-herramientas class="py-5 titulo"
        background="background-image: url({{ asset('storage/img/home/home.jpg')}})" title="Tips"
        description="Consejos útiles de como usar o calcular nuestros productos" :user="$user" />
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3">
                    ...
                    <div class="shadow-blue card">
                        ...
                        <div class="card-img" style="background-image:url(storage/img/calplas-afm.jpg);">
                            <form id="" method="GET" action="" target="_blank">
                                ...
                                <a href="{{ route('guias.filtros.index') }}" type="button"
                    ...
                    <div class="shadow-blue card">
                        ...
                        <div class="card-img" style="background-image:url(storage/img/bombas-saci.jpg);">
                            <form id="" method="GET" action="" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="">
                                <a href="{{ route('guias.bombas.saci.index') }}" type="button"
                                    class="btn btn-acceder shadow-blue ">ACCEDE</a>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="shadow-blue card">
                        ...
                        <div class="card-img" style="background-image:url(storage/img/sugar-valley.png);">
                            <form id="" method="GET" action="" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="">
                                <a href="{{ route('guias.cloradores.index') }}" type="button"
                                    class="btn btn-acceder shadow-blue ">ACCEDE</a>
                            </form>
                        </div>
                    </div>
                ...
                <div class="mb-2 col">
                    <div class="shadow-blue card">
                        <div class="card-body">
                            <h4>Tips TopClean</h4>
                            <p class="card-text">Consejos útiles sobre el limpiafondos automático TopClean</p>
                        </div>
                        <div class="card-img" style="background-image:url(storage/img/topclean.jpg);">
                            <form id="" method="GET" action="" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="">
                                <a href="{{ route('tips.topclean.index', ['user' => $user]) }}" type="button"
                                    class="btn btn-acceder shadow-blue ">ACCEDE</a>
                            </form>
                        </div>
                    </div>
                ...
                <div class="mb-2 col">
                    <div class="shadow-blue card">
                        <div class="card-body">
                            <h4>Tips Filtros</h4>
                            <p class="card-text">Consejos útiles sobre como elegir el filtro adecuado</p>
                        </div>
                        <div class="card-img" style="background-image:url(storage/img/calplas-afm.jpg);">
                            <form id="" method="GET" action="" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="">
                                <a href="{{ route('tips.filtros.index', ['user' => $user]) }}" type="button"
                                    class="btn btn-acceder shadow-blue ">ACCEDE</a>
                            </form>
                        </div>
                    </div>
                ...
                <div class="mb-2 col">
                    <div class="shadow-blue card">
                        <div class="card-body">
                            <h4>Tips Tratamiento</h4>
                            <p class="card-text">Consejos útiles sobre tratamiento del agua</p>
                        </div>
                        <div class="card-img"
                            style="background-image:url(storage/img/tips/tratamiento/filtracion/filtracion-1.png);">
                            <form id="" method="GET" action="" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="">
                                <a href="{{ route('tips.tratamiento.index', ['user' => $user]) }}" type="button"
                                    class="btn btn-acceder shadow-blue ">ACCEDE</a>
                            </form>
                        </div>
                    </div>
