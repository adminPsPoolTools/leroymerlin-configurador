...
try {
   ...
   /*  $mail->SMTPDebug = SMTP::DEBUG_OFF;                      //Enable verbose debug output
    ...
    $mail->Host       = "mail.ps-cover.com";             //"smtp.gmail.com";                     //Set the SMTP server to send through
    ...
    $mail->Username   = 'info@ps-cover.com';                    //SMTP username
    ...
    $mail->Password   = 'PH!atOPlbLgC(*ud';                         //SMTP password
    //$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
